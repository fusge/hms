...
hidden if the `hms_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `hms_DEVELOPER_MODE` to the configure
...
Runs the executable target `hms_exe`.
